...
const CoffeeCard = ({ item, updatedProducts, setUpdatedProducts }) => {
  ...
  return (
    <div
      key={_id}
      className="card card-side bg-neutral shadow-md rounded-md flex flex-col lg:text-row md:flex-row"
    >
      ...
      >
        <h2 className="flex items-center justify-between">
          ...
          <label htmlFor={`my_modal_${_id}`}>
            <span className="btn btn-primary btn-sm w-10 h-10 rounded-md">
        ...
        <p className="flex items-center justify-between">
          ...
          <Link
            ...
            className="btn btn-accent text-white btn-sm w-10 h-10 rounded-md"
          >
        ...
        <p className="flex items-center justify-between">
          ...
          <button
            ...
            className="btn btn-error text-white btn-sm w-10 h-10 rounded-md"
          >
      ...
      <div className="modal">
        <div className="modal-box">
          <form
            onSubmit={(event) => handleModal(event, item)}
            className="card w-full image-full opacity-100"
          >
            <figure>
